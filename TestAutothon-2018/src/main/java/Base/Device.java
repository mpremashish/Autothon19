...
public enum Device {
	MOBILECHROME, MOBILESAFARI, WEBCHROME, WEBFIREFOX, WEBSAFARI, REMOTECHROME;
	...
	public WebDriver setDriver() throws MalformedURLException {
		switch (this) {
			...
			case REMOTECHROME:
				...
				return new RemoteWebDriver(new URL(System.getProperty("seleniumUrl", "http://192.168.56.1:4444/wd/hub")), capability);
